...
class LSTMAutoEncoder( PrepObj ):
  ...
  def __init__(self,n_inits=1,hidden_neurons=30,model_name="ringer_N1_et1_eta1",global_step=None,batch_size=10000,layer=1, d = {}, **kw):
    d.update( kw ); del kw
    from RingerCore import retrieve_kw
    ...
    self._model_filename='/home/users/caducovas/deep_output/ringer_1_1_24_epochs_1_layer_30_units/logs/model'
