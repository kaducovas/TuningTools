...
createTuningJobFiles( outputFolder   = 'sample.Jpsi.20172911.v2.config.n5to20.JK.inits_100by100',
                      neuronBounds   = [5,20],
                      sortBounds     = 10,
                      nInits         = 100,
                      nNeuronsPerJob = 1,
...
#                        nValid = 1,
#                        )
#place = CrossValidArchieve( 'crossValid.20172911', 
...
#place = PreProcArchieve( 'ppFile.20172911', ppCol = ppCol ).save()
